...
if (isset($_GET['product_id'])) {
    ...
    $stmt->execute();
    $row_product_en = $stmt->fetch(PDO::FETCH_ASSOC);
...
if (isset($_POST['del-img'])) {
    ...
    if ($delete_img) {
        echo "<meta http-equiv='refresh' content='0;url=product_edit_en?product_id=$product_id'>";
    }
}
    ...
    if (in_array($fileActExt1, $allow)) {
        if ($img_cover['size'] > 0 && $img_cover['error'] == 0) {
            if (move_uploaded_file($img_cover['tmp_name'], $filePath1)) {
                $product = $conn->prepare("UPDATE product_en SET product_name = :product_name, intro = :intro, 
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="product-name">
                                <h6>Product Name</h6>
                                <input type="text" name="product_name" value="<?php echo $row_product_en['product_name'] ?>" class="form-control">
                                <h6>Introduction</h6>
                                <input type="text" name="intro" value="<?php echo $row_product_en['intro'] ?>" class="form-control">
                            </div>
                            <div class="title">
                                <div class="title-img">
                                    ...
                                    <div id="gallery-cover">
                                        <div class='box-edit-img-cover'>
                                            ...
                                            <img class='edit-img-cover' id='previewImg-cover' src='upload/upload_product/<?php echo $row_product_en['cover_img'] ?>'>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="content">
                                ...
                                <div class="content-text">
                                    <textarea name="content"><?php echo $row_product_en['content'] ?></textarea>
                                    <script>
                                        tinymce.init({
                                            selector: 'textarea',
                                            height: "400",
                        ...
                        <div class="conclude">
                            <h6>Conclusion</h6>
                            <textarea name="conclude"><?php echo $row_product_en['conclude'] ?></textarea>
                            <script>
                                tinymce.init({
                                    selector: 'textarea',
                                    height: "300",
                        ...
                        <div class="clip">
                            <div class="box-clip">
                                <h6>Link Video</h6>
                                <input type="text" name="link" value="<?php echo $row_product_en['link_video'] ?>" class="form-control">
                            </div>
                        </div>
