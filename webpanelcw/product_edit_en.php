...
if (isset($_POST['edit-product'])) {
    ...
    $select_type = $conn->prepare("SELECT * FROM category_product_en WHERE type_name= :type_name");
    $select_type->bindParam(':type_name', $pt_id);
    $select_type->execute();
    $query =  $select_type->fetch(PDO::FETCH_ASSOC);


    $select_sub = $conn->prepare("SELECT * FROM category_sub_en WHERE sub_name= :sub_name");
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            $select_pro = $conn->prepare("SELECT * FROM category_product_en WHERE pt_id = :pt_id");
                            $select_pro->bindParam(':pt_id', $row_product['pt_id']);
                            $select_pro->execute();
                            $query =  $select_pro->fetch(PDO::FETCH_ASSOC);


                            $select_sub_cat = $conn->prepare("SELECT * FROM category_sub_en WHERE id = :id");
