...
$slide_text = $conn->prepare("SELECT * FROM slide_text_cn");
$slide_text->execute();
$row_slide_text_cn = $slide_text->fetch(PDO::FETCH_ASSOC);
        ...
        if ($img['size'] > 0 && $img['error'] == 0) {
            if (move_uploaded_file($img['tmp_name'], $filePath1)) {
                ...
                $(document).ready(function() {
                    ...
                    echo "<meta http-equiv='refresh' content='1.5;url=index_cn'>";
                } else {
                    echo "<script>
        $(document).ready(function() {
            Swal.fire({
...
if (isset($_POST['save_text'])) {
    ...
    $text = $conn->prepare("UPDATE slide_text_cn SET slide_text = :slide_text");
            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="flex-end">
                            <a href="index"><button type="button" class="btn btn-edit1">TH</button></a>
                            <a href="index_en"><button type="button" class="btn btn-edit1">EN</button></a>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="box-slide-text">
                            <div class="content-text">
                                <form method="post">
                                    ...
                                    <textarea name="slide_text1"><?php echo $row_slide_text_cn['slide_text'] ?></textarea>
                                </form>
                                <script>
                                    tinymce.init({
                                        selector: 'textarea',
