            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="box-lang">  
                            <a href="about_us"><button type="button" class="btn btn-edit">TH</button></a>
                            <a href="about_us_cn"><button type="button" class="btn btn-edit">CN</button></a>
                            <a href="about_us_en_edit"><button type="button" class="btn btn-edit1">Edit</button></a>
                        </div>
                    </div>
                    <div class="card-body">
