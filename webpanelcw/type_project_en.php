...
$data_ref = $conn->prepare("SELECT * FROM category_ref_en");
$data_ref->execute();
...
if (isset($_POST['edit-ref'])) {
    ...
    $edit_project_ref = $conn->prepare("UPDATE category_ref_en SET ref_name = :ref_name WHERE ref_id = :ref_id");
    ...
    if ($edit_project_ref) {
        ...
        echo "<meta http-equiv='refresh' content='2;url=type_project_en'>";
    } else {
        echo "<script>
                    $(document).ready(function() {
                        Swal.fire({
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="flex-end">
                            ...
                            <a href="type_project_cn"><button type="button" class="btn btn-edit1">CN</button></a>
                            <a href="type_project_add_en"><button type="button" class="btn btn-edit1">Add</button></a>
                        </div>
                    </div>
                    <div class="card-body">
