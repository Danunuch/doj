...
$data_ref = $conn->prepare("SELECT * FROM category_ref");
$data_ref->execute();
...
if (isset($_POST['edit-ref'])) {
    ...
    $edit_project_ref = $conn->prepare("UPDATE category_ref SET ref_name = :ref_name WHERE ref_id = :ref_id");
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="flex-end">
                            ...
                            <a href="type_project_add"><button type="button" class="btn btn-edit1">Add</button></a>
                        </div>
                    </div>
                    <div class="card-body">
