...
$data_typepro = $conn->prepare("SELECT * FROM category_product_cn");
$data_typepro->execute();
$row_type_product = $data_typepro->fetchAll();

$data_sub = $conn->prepare("SELECT * FROM category_sub_cn");
$data_sub->execute();
...
if (isset($_POST['edit-type-pro'])) {
    ...
    $edit_product_ref = $conn->prepare("UPDATE category_product_cn SET type_name = :type_name WHERE pt_id = :pt_id");
...
if (isset($_POST['edit-sub'])) {
    ...
    $edit_sub = $conn->prepare("UPDATE category_sub_cn SET sub_name = :sub_name WHERE id = :id");
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="type_product_en"><button type="button" class="btn btn-edit1">EN</button></a>
                            ...
                            <a href="type_add_cn"><button type="button" class="btn btn-edit1">Add</button></a>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="card-header">
                            ...
                            <a href="sub_add_cn"><button type="button" class="btn btn-edit1">Add</button></a>
                        </div>
                            </div>
                            <div class="table-responsive">
                                <table class="table">
