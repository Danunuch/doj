                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="flex-end">
                                ...
                                <a href="project_ref_add_en"><button type="button" class="btn btn-edit">Add</button></a>
                                    ...
                                    ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <div class="manage">
                                                        <a href="project_ref_edit_en?project_id=<?php echo $row_project_en[$i]['project_id']; ?>"><button type="button" class="btn" style="background-color:#ffc107; color: #FFFFFF;"><i class="bi bi-pencil-square"></i></button></a>
