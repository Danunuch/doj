...
elevateZoomWidget.init(), $(document).ready(function () {
    countDown(!0), productSmall(), expanderList(), collapseBlock(), submenuBlock(), listingModeToggle(), slideColumn(), inputCounter(), footerCollapse(),searchDropDown(), cartSlideIni(), radioClickList(), calendarDatepicker(), priceSlider(), verticalCarousel(), gridGalleryMasonr(), headerViewSearch(), videoPopup(), videoPost(), setSlickGallery($(".slider-blog-fluid"), 1, 1, 1, 1, 1, "slickSlider"), setSlickGallery($(".brands-page-js"), 6, 5, 4, 2, 1, "carousel"), setSlickGallery($(".carousel-menu-2"), 5, 5, 4, 3, 2, "carousel"), setSlickGallery($(".bigGallery"), 3, 3, 3, 2, 1, "carousel"), setSlickGallery($(".mobileGallery"), 1, 1, 1, 1, 1, "carousel"), setSlickGallery($(".carousel-products-recommend"), 4, 4, 3, 2, 2, "carousel"), setSlickGallery($(".carousel-products-3"), 2, 2, 2, 2, 1, "carousel"), setSlickGallery($(".mobileGallery-product"), 1, 1, 1, 1, 1, "carousel"), setSlickGallery($(".mobileGallery-product-big"), 2, 2, 2, 2, 1, "carousel"), setSlickGallery($(".slider-blog"), 1, 1, 1, 1, 1, "carousel"), initStuck(), mobileparentcart(), mobileParentCurrency(), mobileParentLanguage(), $(window).trigger("resize"), setTimeout(function () {
